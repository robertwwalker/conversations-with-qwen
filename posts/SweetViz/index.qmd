...
bond_report.show_html("bond_funds_analysis.html")

# Alternative: Analyze with Fees as target variable
risk_report = sv.analyze(df, target_feat = "Fees")
risk_report.show_html("bond_funds_fees_analysis.html")
...
* [Analysis](./bond_funds_analysis.html)   
* [Fees Analysis](./bond_funds_fees_analysis.html)